(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["UnicornLogger"] = factory();
	else
		root["UnicornLogger"] = factory();
...
var _debug = __webpack_require__(105);

var _debug2 = _interopRequireDefault(_debug);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var consoleLog = typeof console.log === 'function' ? console.log.bind(console) : function () {};
/* eslint-disable no-console, no-sequences */

var consoleInfo = typeof console.info === 'function' ? console.info.bind(console) : consoleLog;
var consoleWarn = typeof console.warn === 'function' ? console.warn.bind(console) : consoleLog;
var consoleError = typeof console.error === 'function' ? console.error.bind(console) : consoleLog;
var consoleTrace = typeof console.trace === 'function' ? console.trace.bind(console) : consoleLog;
var consoleAssert = typeof console.assert === 'function' ? console.assert.bind(console) : consoleLog;
var consoleGroup = typeof console.group === 'function' ? console.group.bind(console) : consoleLog;
var consoleGroupCollapsed = typeof console.groupCollapsed === 'function' ? console.groupCollapsed.bind(console) : consoleLog;
var consoleGroupEnd = typeof console.groupEnd === 'function' ? console.groupEnd.bind(console) : function () {};
var consoleClear = typeof console.clear === 'function' ? console.clear.bind(console) : function () {};

var MAX_TIMERS = 1000;

var logToTable = function logToTable(namespace, color1, color2, color3) {
	...
	args.forEach(function (arg) {
		if (arg && (!Array.isArray(arg) || (typeof arg === 'undefined' ? 'undefined' : (0, _typeof3.default)(arg)) === 'object')) {
			console.table(arg);
...
var consoleTable = typeof console.table === 'function' && typeof console.group === 'function' && typeof console.groupEnd === 'function' ? logToTable : consoleLog;

var defaultCleaner = function defaultCleaner(args) {
	return args;
};
 ...
 * @returns {this}
 */
function UnicornLogger(namespace) {
	var _this = this;

	var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
	    _ref$cleaner = _ref.cleaner,
	    cleaner = _ref$cleaner === undefined ? defaultCleaner : _ref$cleaner,
	    _ref$maxTimers = _ref.maxTimers,
	    maxTimers = _ref$maxTimers === undefined ? MAX_TIMERS : _ref$maxTimers;

	(0, _classCallCheck3.default)(this, UnicornLogger);
  ...
  */
	...
	this.log = function () {
		...
		return log.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	var assert = (0, _debug2.default)(namespace);
	...
	this.assert = function () {
		...
		return assert.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	var info = (0, _debug2.default)(namespace);
	...
	this.info = function () {
		...
		return info.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	...
	this.warn = function () {
		...
		return warn.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	...
	this.error = function () {
		...
		return error.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	var trace = (0, _debug2.default)(namespace);
	...
	this.trace = function () {
		...
		return trace.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	var table = (0, _debug2.default)(namespace);
	...
	this.table = function () {
		...
		return table.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	var group = (0, _debug2.default)(namespace);
	...
	this.group = function () {
		...
		return group.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	var groupCollapsed = (0, _debug2.default)(namespace);
	...
	this.groupCollapsed = function () {
		...
		return groupCollapsed.apply(undefined, (0, _toConsumableArray3.default)(_this.cleaner(args))), _this;
	};
  ...
  */
	var clear = (0, _debug2.default)(namespace);
	clear.log = function () {
		return consoleClear();
	};
	this.clear = function () {
  ...
  */
	var groupEnd = (0, _debug2.default)(namespace);
	groupEnd.log = function () {
		return consoleGroupEnd();
	};
	this.groupEnd = function () {
		return groupEnd(), _this;
	};
  ...
  */
	var time = (0, _debug2.default)(namespace);
	time.log = function (ns, c1, c2, c3, label) {
		var MaxTimers = _this.maxTimers,
		    timers = _this.timers;

		if ((0, _from2.default)(timers.keys()).length >= MaxTimers) {
			_this.warn('Failed call to .time(' + label + '). You have exceeded the maximum number of timers (' + MaxTimers + ') for this Logger instance.');
			return;
		}
		timers.set(label, Date.now());
	};
	this.time = function (label) {
		return time(label), _this;
	};
  ...
  */
	var timeEnd = (0, _debug2.default)(namespace);
	timeEnd.log = function (ns, c1, c2, c3, label) {
		var timers = _this.timers;

		if (!timers.has(label)) {
			_this.error('No timer with the label ' + label + ' exists for this Logger instance.');
			return;
		}
		var timePassed = Date.now() - Number(timers.get(label));
		timers.delete(label);
		_this.log('label: ' + timePassed + 'ms');
	};
	this.timeEnd = function (label) {
		return timeEnd(label), _this;
	};
	...
	return (0, _assign2.default)(function () {
		...
		return _this.log(args);
	}, { debug: log }, this);
};

exports.default = UnicornLogger;
